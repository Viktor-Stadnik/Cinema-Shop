...
public class MovieSessionController {
    ...
    @PostMapping
    public MovieSessionResponseDto save(@RequestBody @Valid MovieSessionRequestDto requestDto) {
        MovieSession movieSession = movieSessionService.save(
    ...
    public List<MovieSessionResponseDto> getAllAvailable(@RequestParam Long movieId,
                                                         ...
                                                         @DateTimeFormat(pattern =
                                                                 ...
                                                                 LocalDate date) {
        return movieSessionService.findAvailableSession(movieId, date)
                .stream()
